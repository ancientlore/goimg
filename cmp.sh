...
docker export goimg2 | tar -tv | cut -b "1-28,49-" > cmp-goimg-pub.txt
...
docker cp goimg2:/etc/passwd goimg-pub-passwd.txt
docker cp goimg2:/etc/group goimg-pub-group.txt
